...
.cheat:hover {
    ...
    header.innerHTML = `Hawk Cheat Menu <span style="font-size: 0.75rem">v1.00.00</span>`;
    ...
    footer.innerHTML = `<span>GUI by Clash098<br>Cheats by Clash098 </span>`;
